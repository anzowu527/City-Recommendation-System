# this file is for scraping the city average highest temperatures throughout a year
# this file will auto-generate the weatherHigh.xlsx to store the information
...
def createExcel1():
    ...
    wb.save(f'../weather/weatherHigh.xlsx')
    wb = load_workbook('weatherHigh.xlsx')
    ws = wb.active
...
def main():
    createExcel1()
    wb = load_workbook(filename='weatherHigh.xlsx')
    ws = wb.active
    d = 1
    for i in range(0, len(index)):
        ...
        h = browser.find_elements(By.XPATH, '//*[@id="Report-Content"]/div[2]/div[2]/div[1]/table/tbody/tr/td/table/tbody/tr[1]')
